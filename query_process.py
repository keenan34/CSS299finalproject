...
from index import Index, NaiveIndex, ListBasedInvertedIndexWithFrequencies, \
    DictBasedInvertedIndexWithFrequencies
...
def create_dict_index_query_process(index_filename, corpus_filename) -> QueryProcess:
...
def main(index_filename: str, corpus_filename: str) -> None:
    """
    ...
    :param corpus_filename: The file to read the source data from.
    """
    qp = create_dict_index_query_process(
        index_filename=index_filename, corpus_filename=corpus_filename)
